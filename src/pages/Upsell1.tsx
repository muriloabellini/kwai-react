...
const Upsell1 = () => {
  ...
  const checkPaymentStatus = async (transactionId: string) => {
    try {
      ...
      if (data.status === "APPROVED") {
        ...
        // Redireciona para a página upsell2 após 2 segundos
        setTimeout(() => {
          navigate('/upsell2');
        }, 2000);
      }
  ...
  const handleRefazerPagamento = async () => {
      ...
      <div className="px-4 py-6 max-w-md mx-auto">
        ...
        <div className="bg-red-100 border border-red-400 rounded-lg p-3 mb-6 flex items-start space-x-2">
          ...
          <span className="text-red-800 text-sm font-medium">
            Falha no Pagamento - R$ 24,90
          </span>
        </div>

        {/* Título */}
        <h1 className="text-xl font-bold text-gray-900 mb-4 leading-tight">
          Algo deu errado na sua tentativa de pagamento.
        </h1>

        {/* Texto explicativo */}
        <p className="text-gray-700 text-sm mb-4">
          Identificamos uma falha na transação anterior e, por isso, seu acesso ainda não foi liberado. Esse tipo de erro pode acontecer por <strong>instabilidade bancária</strong> ou <strong>segurança antifraude automática</strong>.
        </p>

        <div className="bg-blue-50 border-l-4 border-blue-400 p-3 mb-6">
          <p className="text-blue-800 text-sm">
            <strong>Recomendamos que você refaça o pagamento agora</strong> para não perder sua solicitação. Caso o valor anterior tenha sido descontado, o sistema garante o <strong>estorno automático</strong> da cobrança duplicada.
          </p>
        </div>

        {/* Resumo */}
        <div className="bg-gray-100 rounded-lg p-4 mb-6">
          <h2 className="font-bold text-gray-900 mb-3">Resumo do Pagamento</h2>
          ...
          <div className="mt-3 flex items-start space-x-2">
            <div className="bg-orange-600 rounded-full p-1 mt-0.5">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="white">
                <path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"/>
              </svg>
            </div>
            <p className="text-xs text-gray-600">
              Finalize sua ativação com segurança e prossiga normalmente.
            </p>
          </div>
        </div>

        {/* Botão Refazer Pagamento */}
        <button 
          onClick={handleRefazerPagamento}
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <h3 className="font-bold text-gray-900">Proteção contra cobrança duplicada</h3>
          </div>
          <p className="text-sm text-gray-600">
            Nosso sistema garante o estorno automático caso você seja cobrado duas vezes pelo mesmo serviço.
          </p>
        </div>
        ...
        {/* Dúvidas Frequentes */}
        <div className="mb-6">
          <h2 className="font-bold text-xl text-gray-900 mb-4">Por que meu pagamento falhou?</h2>
          
          <div className="space-y-3">
            <div className="border-b border-gray-200 pb-3">
              <p className="font-medium text-gray-900 text-sm">
                Instabilidade bancária ou problemas de conexão durante a transação
              </p>
            </div>
            
            <div className="border-b border-gray-200 pb-3">
              <p className="font-medium text-gray-900 text-sm">
                Sistemas de segurança antifraude automáticos
              </p>
            </div>
            
            <div className="border-b border-gray-200 pb-3">
              <p className="font-medium text-gray-900 text-sm">
                E se eu for cobrado duas vezes?
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 flex items-end justify-center z-50">
          <div className={`bg-white w-full max-w-md rounded-t-2xl p-6 shadow-2xl transform transition-all duration-1500 ease-out ${
            ...
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-bold text-gray-900">Refazer Pagamento via PIX</h3>
              <button 
                onClick={() => {
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
              <p className="text-blue-800 text-sm">
                <strong>Instruções:</strong> Escaneie o QR Code ou copie a chave PIX para refazer o pagamento de R$ 24,90. 
