...
import { CheckCircle, Star, Crown, Gem, Copy, Check, User, Sparkles, Zap, Package } from 'lucide-react';
...
const Upsell5 = () => {
  ...
  const [isGeneratingPix, setIsGeneratingPix] = useState('');
  ...
  const plans = [
    {
      id: 'bonus5x',
      name: 'Bônus de Ganhos 5x',
      earning: '5x Ganhos',
      price: '14,90',
      originalPrice: 'R$29,80',
      badge: 'Primeiras 72h',
      gradientFrom: 'from-purple-400',
      gradientTo: 'to-purple-600',
      icon: Sparkles,
      features: [
        'Multiplica ganhos por 5',
        'Válido nas primeiras 72h',
        'Ativação imediata'
      ]
    },
    {
      ...
      features: [
        ...
        'Evita cobranças mensais',
        'Pagamento único'
      ]
    },
    {
      id: 'acelerador',
      name: 'Acelerador de Vídeos',
      earning: '3x Velocidade',
      price: '9,90',
      ...
      icon: Zap,
      features: [
        'Assiste vídeos 3x mais rápido',
        'Ganha mais em menos tempo',
    ...
    },
    {
      id: 'combo',
      name: 'Combo Completo',
      earning: 'Todos Benefícios',
      price: '34,90',
      originalPrice: 'R$89,50',
      badge: 'Melhor Oferta',
      gradientFrom: 'from-orange-400',
      gradientTo: 'to-red-600',
      icon: Package,
      features: [
        'Bônus 5x + Acesso Vitalício',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6 max-w-md mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Adicione benefícios extras à sua conta
          </p>
        </div>
            ...
            return (
              <Card 
                ...
                className={`bg-white shadow-lg rounded-2xl border-0 transition-all cursor-pointer hover:shadow-xl ${
                  plan.id === 'combo' ? 'ring-2 ring-orange-400' : ''
                }`}
              >
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        {plan.id === 'combo' && (
                          <Badge className="bg-orange-400 text-orange-900 text-xs">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-gray-500">benefício</div>
                    </div>
                  </div>
